...
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResponse::errcode() const {
  // @@protoc_insertion_point(field_get:testProto.LoginResponse.errcode)
...
inline void LoginResponse::set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:testProto.LoginResponse.errcode)
}
...
inline const std::string& LoginResponse::errmsg() const {
  // @@protoc_insertion_point(field_get:testProto.LoginResponse.errmsg)
  return _internal_errmsg();
}
inline void LoginResponse::set_errmsg(const std::string& value) {
  _internal_set_errmsg(value);
  // @@protoc_insertion_point(field_set:testProto.LoginResponse.errmsg)
}
inline std::string* LoginResponse::mutable_errmsg() {
  // @@protoc_insertion_point(field_mutable:testProto.LoginResponse.errmsg)
...
inline void LoginResponse::set_errmsg(std::string&& value) {
  ...
  errmsg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:testProto.LoginResponse.errmsg)
}
inline void LoginResponse::set_errmsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:testProto.LoginResponse.errmsg)
}
inline void LoginResponse::set_errmsg(const char* value, size_t size) {
  ...
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:testProto.LoginResponse.errmsg)
}
...
inline std::string* LoginResponse::release_errmsg() {
  // @@protoc_insertion_point(field_release:testProto.LoginResponse.errmsg)
...
inline void LoginResponse::set_allocated_errmsg(std::string* errmsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:testProto.LoginResponse.errmsg)
}
